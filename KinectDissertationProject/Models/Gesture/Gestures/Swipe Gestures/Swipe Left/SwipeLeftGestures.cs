...
namespace KinectDissertationProject.Models.Gesture.Gestures.Swipe_Gestures.Swipe_Left
{
    public static class SwipeLeftGesture
    {
        ...
        private static OneHandGestureSegment[] GetOffHandRaisedLeftSegments(JointType dominantHand)
        {
            ...
            gestureSegments[0] = SwipeLeftGestureSegment1.WithOffHandRaisedLeft(dominantHand);
            gestureSegments[1] = SwipeLeftGestureSegment2.WithOffHandRaisedLeft(dominantHand);
            return gestureSegments;
        }

        private static GestureType GetOffHandRaisedLeftType(JointType dominantHand)
        {
            return dominantHand.IsRight() ? GestureType.RIGHT_SWIPE_LEFT_LEFT_HAND_RAISED_LEFT : throw new NotImplementedException();
        }
